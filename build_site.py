...
from graph_designer import init_graph_html
...
for key in PROBLEM_KEYS:    
    ...
    task += 1
#f.write("def graph(request): # definisco il nome della view\n")
#f.write("    return render(request,os.path.join('esame','grafo.html'))\n")
